...
- 2026-05-11: Item 5 implemented by Hermes agent by cleaning mixed current+legacy hook settings without duplicate current hooks, parent verification passed (`19 passed`, ruff clean, `pyright src/cctelegram/hook.py` clean), independent Hermes reviewer returned PASS. Ready to freeze/commit.
